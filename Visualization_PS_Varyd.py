...
X1,X2,X3,X4,X5,X6,X7,X8,X9,X10=V4_1
X11,X12,X13,X14,X15,X16,X17,X18,X19,X20=V4_3
X21,X22,X23,X24,X25,X26,X27,X28=V4_2
X29,X30,X31,X32,X33,X34,X35,X36=V4_4
t = times
d=5e-8
...
M = (np.hypot(DX1, DX22))
M[M == 0] = 1.
ax4.streamplot(Y1, Y22, DX1, DX22, color=M,cmap=mappy,linewidth=2)
ax4.scatter([X1[tchoose]],[X22[tchoose]],s=200,c=dotcolor,zorder=10)
ax4.set_xlabel("X1")
ax4.set_ylabel("X22")
ax4.plot(X1, X22, 'k-',linewidth=linewidthy)
ax4.grid()
ax4.legend(loc='best')
ax4.legend(loc='best')
ax4.set_xlim([np.min(dimx1),np.max(dimx1)])
ax4.set_ylim([np.min(dimx22),np.max(dimx22)])


X1,X2,X3,X4,X5,X6,X7,X8,X9,X10=V5_1
X11,X12,X13,X14,X15,X16,X17,X18,X19,X20=V5_3
X21,X22,X23,X24,X25,X26,X27,X28=V5_2
X29,X30,X31,X32,X33,X34,X35,X36=V5_4
t = times
d=1e-7
...
M = (np.hypot(DX1, DX22))
M[M == 0] = 1.
ax5.streamplot(Y1, Y22, DX1, DX22, color=M,cmap=mappy,linewidth=2)
ax5.scatter([X1[tchoose]],[X22[tchoose]],s=200,c=dotcolor,zorder=10)
ax5.set_xlabel("X1")
ax5.set_ylabel("X22")
ax5.plot(X1, X22, 'k-',linewidth=linewidthy)
ax5.grid()
ax5.legend(loc='best')
ax5.legend(loc='best')
ax5.set_xlim([np.min(dimx1),np.max(dimx1)])
ax5.set_ylim([np.min(dimx22),np.max(dimx22)])
